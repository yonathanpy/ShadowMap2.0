...
# Spinner Animation
# ==========================
def spinner(msg="Processing", duration=2):
    chars = "|/-\\"
...
# ==========================
COMMON_SUBS = ["www","mail","ftp","dev","api","test","beta","staging"]
def subdomain_scan():
    domain = safe_input("Domain: ")
...
""")
        ...
        elif choice == "2": reverse_dns()
        elif choice == "3": whois_lookup()
        elif choice == "4": http_headers()
        elif choice == "5": ssl_info()
        elif choice == "6": port_scan()
        elif choice == "7": nmap_scan()
        elif choice == "8": banner_grab()
        elif choice == "9": subdomain_scan()
        elif choice == "10": hash_file()
        elif choice == "11": local_info()
        elif choice == "12": ping()
